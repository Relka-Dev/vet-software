...
from .models import (
    RoomType, Room, EmergencyType, Procedure, Equipment,
    Appointment, AppointmentProcedure, AppointmentEquipment, AppointmentItem
)
...
class EmergencyTypeModelTest(TestCase):
    ...
    def test_verbose_names(self):
        ...
        self.assertEqual(EmergencyType._meta.verbose_name_plural, "Types de rendez-vous")
...
class AppointmentModelTest(TestCase):
    ...
    def test_clean_no_conflict(self):
        """Test que clean ne lève pas d'erreur sans conflit"""
        appointment = Appointment(
            animal=self.animal,
            room=self.room,
            employee=self.employee,
...
class AppointmentProcedureModelTest(TestCase):
    ...
    def setUp(self):
        ...
        employee = Employee.objects.create(
            person=person,
            first_engagement_date=date(2021, 1, 1),
            role=role
        )
    ...
    def test_verbose_names(self):
        """Test des verbose_names"""
        self.assertEqual(AppointmentProcedure._meta.verbose_name, "Association consultation/procédure")
        self.assertEqual(AppointmentProcedure._meta.verbose_name_plural, "Associations consultation/procédure")
...
class AppointmentEquipmentModelTest(TestCase):
    ...
    def setUp(self):
        ...
        employee = Employee.objects.create(
            person=person,
            first_engagement_date=date(2019, 6, 1),
            role=role
        )
    ...
    def test_verbose_names(self):
        """Test des verbose_names"""
        self.assertEqual(AppointmentEquipment._meta.verbose_name, "Association consultation/équipement")
        self.assertEqual(AppointmentEquipment._meta.verbose_name_plural, "Associations consultation/équipement")
...
class AppointmentItemModelTest(TestCase):
    ...
    def setUp(self):
        ...
        employee = Employee.objects.create(
            person=person,
            first_engagement_date=date(2018, 3, 15),
            role=role
        )
    ...
    def test_verbose_names(self):
        """Test des verbose_names"""
        self.assertEqual(AppointmentItem._meta.verbose_name, "Association consultation/article")
        self.assertEqual(AppointmentItem._meta.verbose_name_plural, "Associations consultation/article")