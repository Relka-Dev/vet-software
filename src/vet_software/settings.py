"""
Django settings for vet_software project.
...
SECRET_KEY = os.getenv(
    'SECRET_KEY', 'django-insecure-pqfy)2(y2508l$-j@#aq2y2%cg^%z@^_egbynia*t#f*-vb9az'
)
...
WSGI_APPLICATION = 'vet_software.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@vetsoftware.com')
